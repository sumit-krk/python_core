...
> **Note:** These questions are based only on the concepts covered in this document. They do not require knowledge of loops, lists, tuples, dictionaries, functions, exception handling, or other future topics.
...
Before moving to the next topic, make sure you can explain the difference between:
